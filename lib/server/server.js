...
Push.addListener('token', function(currentToken, value) {
  console.log("AEBS Push.addListener('token'");
  ...
  'raix:push-update': function(options) {
    ...
    if (!doc) {
      ...
      if (options.id) {
        ...
        console.log("AEBS no id; inserting new")
