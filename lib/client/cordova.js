  ...
  document.addEventListener('deviceready', function() {
    ...
    if (typeof pushNotification.setApplicationIconBadgeNumber == 'function') {
      ...
      pushNotification.setApplicationIconBadgeNumber(function(result) {
        // Success callback
        console.log("AEBSDEBUG reset badge -- success!")
      }, function(err) {
        // Error callback
        console.error("AEBSDEBUG reset badge -- FAIL!")
...
Push.Configure = function(options) {
  console.log("Push.Configure client side called; AEBS")
  Push.debug = true;
  ...
  if (Push.debug) console.log(options);
  ...
  Meteor.startup(function() {
    ...
    console.log("Does anyone run me?!");
