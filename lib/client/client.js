...
//console.log("AEBSDEBUG addUserId=" + addUserId)
/*
...
var loadLocalstorage = function() {
  ...
  try {
    ...
    console.error("AE Error using the local storage");
  }
...
var saveLocalstorage = function(data) {
  try {
    ...
    // XXX: storage error
    //console.log("AEBSDEBUG XXX: storage error")
  }
};
...
initPushUpdates = function(appName) {
  ...
  //console.log("AEBS initPushUpdates");
  ...
  Push.addListener('token', function(token) {
    ...
    //console.log('token event emitted! Inside the listener -- calling server!');
